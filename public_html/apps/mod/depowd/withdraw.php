...
if (empty($towd) || empty($toAddress)) {
	...
	if ($saldo < $towd || $towd < 0) {
		...
		$quwd = "insert into withdraw set wd_id='$wdid',user_id='$_SESSION[user_id]',fee_wd='$feewd',wd_beforefee='$beforefee',total_wd='$amountwd',total_idr='$rupiahwd',tanggal_wd='$time_now', address='$toAddress'";
