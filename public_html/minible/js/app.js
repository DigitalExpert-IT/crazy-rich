!(function (a) {
    ...
    a("#side-menu").metisMenu(),
        a(".vertical-menu-btn").click(function (e) {
        ...
        a(document).ready(function () {
            var e;
            0 < a("#sidebar-menu").length && 300 < (e = a("#sidebar-menu .mm-active .active").offset().top) && ((e -= 300), a(".vertical-menu .simplebar-content-wrapper").animate({ scrollTop: e }, "slow"));
        }),
        a('[data-bs-toggle="fullscreen"]').click(function (e) {
            e.preventDefault(),
        ...
        a(".right-bar-toggle").clicl(function (e) {
            a("body").toggleClass("right-bar-enabled");
        }),
        a(document).click("body", function (e) {
        ...
        window.sessionStorage && ((n = sessionStorage.getItem("is_visited")) ? (a(".right-bar input:checkbox").prop("checked", !1), a("#" + n).prop("checked", !0), t(n)) : sessionStorage.setItem("is_visited", "light-mode-switch")),
