...
$code = mysqli_real_escape_string($con, $_GET['c']);
$nama = mysqli_real_escape_string($con, $_GET['n']);
// echo $baseurl;
$html = '<head>
            ...
            <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
             ...
             https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                              <tr>
                                <td align="center">
                                  <a href="' . $baseurl . '/verification.php?verification=' . $code . '&email=' . $email . '" class="f-fallback button" target="_blank" style="color:white;text-decoration: none;">Confirmation</a>
                                </td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td>
                            <p class="f-fallback sub align-center">If you don\'t see the Confirm button, <a
                                href="' . $baseurl . '/verification.php?verification=' . $code . '&email=' . $email . '">Click
                                Here</a>.</p>
                          </td>
                        </tr>
                      </table>
...
<title>Crazy Rich Trading - Verification</title>
  ...
  <div class="list-message">
   <div class="header"><img src="assets/images/logo/newLogo.png" width="300px" height="auto" /></div>
    <hgroup class="text-center">
      <h2><span>Please Verification Your Email, ' . $nama . '</span></h2>
    </hgroup>
    <p>An email containing instructions for verifying your Crazy Rich Trading account has been sent to<em><strong> ' . $email . '</strong></em>.</p>
    <p>Please check your email for verification.</p>
    <p>If you have not received a verification email from Crazy Rich Trading within 15 minutes,</p>
    <p>Click the button below to send it again</p>
    <br>
    <button class="btn" onclick="resend()" style="background-image: linear-gradient(to right, #480048, #C04848);">
Resend Verification Email</button>
    <BR />
     Check <strong><em>INBOX</em></strong> Section OR <em><strong>SPAM</strong></em> Section</div>
