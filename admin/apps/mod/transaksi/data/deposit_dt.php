...
function modal($id)
{
  ...
  $link = "<a href='#' class='btn btn-success waves-effect waves-light detail' onclick='depoButton($id)' data-id='$id' data-bs-toggle='modal' data-bs-target='#deposit-detail'>Detail</a>";
  return $link;
}
